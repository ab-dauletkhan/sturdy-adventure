...
SECRET_KEY = os.getenv("SECRET_KEY", "ваш_секретный_ключ")
...
CSRF_TRUSTED_ORIGINS = [
    origin.strip()
    for origin in os.getenv("CSRF_TRUSTED_ORIGINS", "https://*.fly.dev").split(",")
    if origin.strip()
]
...
WSGI_APPLICATION = "kiim_shop.wsgi.application"
